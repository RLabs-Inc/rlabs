...
export function getThemeState() {
  ...
  function generate(baseHue: number, scheme: ColorSchemes) {
    ...
    setBrightColors(cssVariables.terminal_colors.bright);
    setNormalColors(cssVariables.terminal_colors.normal);
