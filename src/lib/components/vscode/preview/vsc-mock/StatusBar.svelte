...
<div
  class="flex h-6 w-full items-center truncate overflow-hidden text-xs"
  style="color: var(--fg3); transition-property: all; transition-duration: 100ms;"
>
  <div
    class="flex h-7 w-9 shrink-0 items-center justify-center"
    style="color: var(--fgAc1); background-color: var(--ac1); transition-property: all; transition-duration: 100ms;"
  >
  ...
  <div
    class="flex h-7 flex-1 items-center justify-between truncate overflow-hidden px-2 text-xs"
    style="color: var(--fgAc2); background-color: var(--ac2); transition-property: all; transition-duration: 100ms;"
  >
    <div class="flex items-center space-x-2 truncate overflow-hidden">
      {#each leftItems as item}
        <div
          class="flex cursor-pointer items-center truncate overflow-hidden p-1 transition-colors duration-200 hover:brightness-125"
          style="color: var(--fgAc2); transition-property: all; transition-duration: 100ms;"
        >
          {#if item.icon}
