...
<div
  ...
  style={`background-color: ${bg}; border-color: ${color}; transition-property: all; transition-duration: 100ms;`}
>
  <div
    class="flex w-full cursor-pointer items-center justify-between truncate py-1 pr-2 pl-4 text-xs text-clip capitalize"
