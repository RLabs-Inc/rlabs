...
function M.get(c)
    ...
    return {
        ...
        ['@lsp.mod.static'] = { fg = c.variable_readonly },
        ...
        ['@lsp.type.magicFunction.rust'] = { fg = c.func },
        ['@lsp.type.namespace.rust'] = { fg = c.type },
        ['@lsp.type.operator.rust'] = { fg = c.operator },
        ['@lsp.type.parameter.rust'] = { fg = c.parameter },
        ['@lsp.type.property.rust'] = { fg = c.property },
        ['@lsp.type.selfKeyword.rust'] = { fg = c.support_variable },
        ['@lsp.type.selfTypeKeyword.rust'] = { fg = c.support_variable },
        ['@lsp.type.string.rust'] = { fg = c.string },
        ['@lsp.type.typeAlias.rust'] = { fg = c.type },
        ['@lsp.type.unresolvedReference.rust'] = { fg = c.error },
        ['@lsp.typemod.deriveHelper.attribute.rust'] = { fg = c.attribute },
        ['@lsp.typemod.generic.attribute.rust'] = { fg = c.type_parameter },
